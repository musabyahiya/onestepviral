...
<head>
    ...
    <title>OneStepViral - Social Campaign</title>
        ...
        <div class="row "  style="display:none;">
            <div class="col-lg-10">
                <div class="col-lg-8">
                 ...
                 <div class="btn-group">
                                        <button type="button" id="btnPrevious" onclick="sortCamapign(this)" campaigntype="0" class="btn btn-xs btn-white ">Previous</button>
                                        <button type="button" onclick="sortCamapign(this)" campaigntype="1" class="btn btn-xs btn-white ">Next</button>
...
<script src="../PagesJS/UserCampaign.js"></script>
