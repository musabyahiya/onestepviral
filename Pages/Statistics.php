...
<head>
    ...
    <title>OneStepViral - Social Stats</title>
...
<div id="SearchUser" class="modal fade" role="dialog">
    <div class="modal-dialog" style="width: 90%;height:80%">
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <table id="myTableSearch"  class=" myTable table table-responsive table-hover" style="margin-top:20px;">
                    <thead>
                        <tr class="success">
                            <th>User</th>
                            <th>Action</th>
    ...
    <script src="../PagesJS/Statistics.js"></script>
