...
<head>
    ...
    <title>OneStepViral - Pinterest Campaign</title>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
         ...
         <div class="panel panel-primary" style="margin-top: 20px;">
            ...
            <div class="panel-body">
                <div class="col-lg-4">
                <input type="button" data-toggle="modal" data-target="#CreateCampaign" class="btn btn-primary" value="Create New Pinterest Campaign" />
                </div>
                <div class="col-lg-6">
...
<div id="CreateCampaign" class="modal fade" role="dialog">
    <div class="modal-dialog" style="width: 70%">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4>Create Pinterest Campaign</h4>
...
<script src="../PagesJS/Campaign.js"></script>
</body>
</html>
