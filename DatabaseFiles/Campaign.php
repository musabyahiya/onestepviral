 ...
 if($_GET['action']=='CreateNewCampaign')
 {
    ...
    $query = "INSERT INTO campaign (PostCategoryId ,CampaignTypeId , Title, URL,TitleImagePath, CreatedBy, CreatedDate ) VALUES 
    ( ?,?,?,?,?,?,CURRENT_TIMESTAMP)";
 ...
 if($_GET['action']=='DeleteSelectedCampaign')
 {
    ...
    $statement = $con->query("Update campaign set IsActive = 0,ModifiedBy = $ModifiedBy, ModifiedDate = Now()  where CampaignId in ( $Ids)");
    /*$query = "Update campaign set IsActive = 0 ,ModifiedBy = :ModifiedBy , ModifiedDate = Now() where CampaignId in ( '$Ids')";*/
 ...
 if($_GET['action']=='UpdateCampaign')
 {
    ...
    $query = "Update campaign set  PostCategoryId=:PostCategoryId, CampaignTypeId = :CampaignTypeId, Title = :Title, URL = :URL
 ...
 if($_GET['action']=='DeleteCampaign')
 {
    ...
    $query = "Update campaign set IsActive = 0 ,ModifiedBy = :ModifiedBy , ModifiedDate = Now() where CampaignId = :CampaignId ";
    $statement = $con->prepare($query);
