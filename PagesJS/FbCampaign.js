...
function CreateNewCampaign(PostCategoryId,CampaignTypeId, Title, URL,TitleImagePath)
{
	...
	var request = $.ajax({
		method: "POST",
		url:    "../DatabaseFiles/FbCampaign.php?action=CreateNewCampaign",
...
function UpdateCampaign(CampaignId,PostCategoryId, CampaignTypeId, Title, URL,TitleImagePath)
{
	var request = $.ajax({
		method: "POST",
		url:    "../DatabaseFiles/FbCampaign.php?action=UpdateCampaign",
...
function DeleteCampaign(CampaignId)
{
	var request = $.ajax({
		method: "POST",
		url:    "../DatabaseFiles/FbCampaign.php?action=DeleteCampaign",
...
function GetAllCampaignType()
{
	...
	var request = $.ajax({
		method: "POST",
		url:    "../DatabaseFiles/FbCampaign.php?action=GetAllCampaignType",
		data: {}
	});
	request.done(function(data) {
...
function EditStatus(selector)
{
	...
	var request = $.ajax({
		method: "POST",
		url:    "../DatabaseFiles/FbCampaign.php?action=EditStatus",
...
function  DeleteSelectedCampaign() {
	...
	var request = $.ajax({
		method: "POST",
		url:    "../DatabaseFiles/FbCampaign.php?action=DeleteSelectedCampaign",
