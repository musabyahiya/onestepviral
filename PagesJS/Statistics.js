...
{
	var html = " <div class='panel panel-primary ToHide' style='margin-top: 20px;'> <div class='panel-heading'> Social Stats </div><div class='panel-body'> <input type='button' data-toggle='modal' data-target='#CreateStatistics' class='btn btn-primary' value='Create New Social Stats'/> </div></div>";
...
function CreateNewStatistics(UserId, PageViews, RPM, Revenue, StatsDate)
{
	var request = $.ajax({
		method: "POST",
		url:    "../DatabaseFiles/Statistics.php?action=CreateNewStatistics",
...
function UpdateStatistics(StatsId,UserId, PageViews, RPM, Revenue, StatsDate)
{
	var request = $.ajax({
		method: "POST",
		url:    "../DatabaseFiles/Statistics.php?action=UpdateStatistics",
...
function DeleteStatistics(StatsId)
{
	var request = $.ajax({
		method: "POST",
		url:    "../DatabaseFiles/Statistics.php?action=DeleteStatistics",
...
function GetAllUsers()
{
	var request = $.ajax({
		method: "POST",
		url:    "../DatabaseFiles/Statistics.php?action=GetAllUsers",
		data: {}
	});
	request.done(function(data) {
...
function GetAllStatistics()
{
	...
	var request = $.ajax({
		method: "POST",
		url:    "../DatabaseFiles/Statistics.php?action=GetAllStatistics",
		data: {}
	});
	request.done(function(data) {
...
function EditStatus(selector)
{
	...
	var request = $.ajax({
		method: "POST",
		url:    "../DatabaseFiles/Statistics.php?action=EditStatus",
